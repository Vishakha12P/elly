...
const PromptBox = ({setIsLoading, isLoading}) => {
    ...
    const {user,chats,setChats,selectedchats,setSelectedChat} = useAppContext();
    ...
    const sendPrompt = async (e)=>{
      ...
      try{
        ...
        if(isLoading) return toast.error('Wait fot the previous response');
...
// saving user prompt in selected chat
  ...
  return (
    <form onSubmit={sendPrompt}
        ...
        rows={2}
        placeholder='Message Ellora' required
